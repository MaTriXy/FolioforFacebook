...
public class RoundImage extends ImageView {
    ...
    public RoundImage(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundImage,
                defStyle, 0);

        mMaskDrawable = a.getDrawable(R.styleable.RoundImage_maskDrawable);
        if (mMaskDrawable != null) {
            mMaskDrawable.setCallback(this);
        }

        mBorderDrawable = a.getDrawable(R.styleable.RoundImage_borderDrawable);
        if (mBorderDrawable != null) {
            mBorderDrawable.setCallback(this);
        }

        mDesaturateOnPress = a.getBoolean(R.styleable.RoundImage_desaturateOnPress,
                mDesaturateOnPress);
